...
export default function ProfileView({ userProfile, isOwnProfile, onProfileUpdate }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await showAlert({ type: "success", title: "Profil Diperbarui!", message: "Perubahan profil berhasil disimpan." });
      setIsEditing(false);
      ...
      await showAlert({ type: "error", title: "Gagal Menyimpan!", message: "Terjadi kesalahan saat menyimpan data profil." });
    } finally {
      setIsSaving(false);
    }
  };
  ...
  const handleUploadAvatar = async (e) => {
    ...
    try {
      ...
      await showAlert({ type: "success", title: "Foto Diperbarui!", message: "Foto profil berhasil diubah." });
      if (onProfileUpdate) onProfileUpdate();
    } catch (error) {
      console.error("Gagal upload:", error);
      await showAlert({ type: "error", title: "Upload Gagal!", message: "Gagal mengupload foto profil. Coba lagi." });
    } finally {
