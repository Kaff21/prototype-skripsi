...
export default function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await showAlert({ type: "success", title: "Pendaftaran Berhasil! 🎉", message: "Akun Anda sedang menunggu konfirmasi admin. Silakan login setelah dikonfirmasi." });
      router.push("/auth/login");
    } catch (err) {
      await showAlert({ type: "error", title: "Pendaftaran Gagal!", message: err.response?.data?.error || "Terjadi kesalahan saat mendaftar. Coba lagi." });
    } finally {
      setLoading(false);
    }
  };
